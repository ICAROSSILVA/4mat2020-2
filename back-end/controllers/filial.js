...
controller.listar = async (req, res) => {
    try {
        let dados = await Filial.find() // Traz todos os cursos cadastrados
...
controller.obterUm = async (req, res) => {
    try {
        ...
        let obj = await Filial.findById(id)
...
controller.atualizar = async (req, res) => {
    try {
        ...
        let ret = await Filial.findByIdAndUpdate(id, req.body)
...
controller.excluir = async (req, res) => {
    try {
        ...
        let ret = await Filial.findByIdAndDelete(id)
