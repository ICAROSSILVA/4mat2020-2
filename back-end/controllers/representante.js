...
controller.listar = async (req, res) => {
    try {
        let dados = await Representante.find() // Traz todos os cursos cadastrados
...
controller.obterUm = async (req, res) => {
    try {
        ...
        let obj = await Representante.findById(id)
...
controller.atualizar = async (req, res) => {
    try {
        ...
        let ret = await Representante.findByIdAndUpdate(id, req.body)
...
controller.excluir = async (req, res) => {
    try {
        ...
        let ret = await Representante.findByIdAndDelete(id)
